...
namespace WebAppGestorPacientes.Controllers
{
    public class LaboratoryTestResultController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(SaveLaboratoryTestResultViewModel saveLaboratoryResult, int medicalId)
        {
            List<LaboratoryTestViewModel> laboratoryTest = await _laboratoryTestService.GetAll();
            ViewBag.laboratory = laboratoryTest;
            ...
            if (saveLaboratoryResult.LaboratoryTests == null)
            {
                ModelState.AddModelError("IdLaboratoryTest", "This input is obligatory");
                return View("SaveLaboratoryTestResult", saveLaboratoryResult);
            }
        ...
        public async Task<IActionResult> SearchIdentification(string Identification)
        {
            ...
            return View("Index", identificationViewModel);
        }
